...
def Relatorio_1():    
    janela.destroy() 
    from Relatorio_1 import Relatorio_1
    Relatorio_1()

def Relatorio_2():    
    janela.destroy() 
    from Relatorio_2 import Relatorio_2
    Relatorio_2()

def Relatorio_3():    
    janela.destroy() 
    from Relatorio_3 import Relatorio_3
    Relatorio_3()
...
botaoCad = Button(janela, width=15, text='1º : Informática', font=("Arial", 10, "bold"), fg=corBranca, bg=corRoxo, command = Relatorio_1)
botaoCad.place(x=185, y=120)

botaoCad = Button(janela, width=15, text='2º : Informática', font=("Arial", 10, "bold"), fg=corBranca, bg=corRoxo, command = Relatorio_2)
botaoCad.place(x=185, y=155)

botaoCad = Button(janela, width=15, text='3º : Informática', font=("Arial", 10, "bold"), fg=corBranca, bg=corRoxo, command = Relatorio_3)
